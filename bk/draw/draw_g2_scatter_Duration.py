...
def draw(name,level,cmap,RGBs):
    list = ['S_Duration','D_Duration_mean']
...
def S_Duration():
    name = ['S_Duration', 'S_Duration', 'S_Duration', 'total number of days using bedrock water from 2003.01.01 to 2020.12.31']
    level = np.arange(0,1500,250)
    cmap = cmaps.StepSeq25_r
    draw(name,level,cmap,RGBs)

def D_Duration_mean():
    name = ['D_Duration_mean', 'D_Duration_mean', 'D_Duration_mean', '  total number of days using bedrock water in a year (mean from 2003-2020)']
    level = np.arange(0,90,15)
    cmap = cmaps.StepSeq25_r
    draw(name,level,cmap,RGBs)
