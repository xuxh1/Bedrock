...
# def Ssoil_case1():
#     name = [f'{path1}Ssoil_mean', 'Ssoil', 'Ssoil_case1', 'model case1 $S_{soil}$ (mm)']
#     level = level1
#     cmap = cmap1
#     draw(name,level,cmap)
        
# def Ssoil_case2():
#     name = [f'{path2}Ssoil_mean', 'Ssoil', 'Ssoil_case2', 'model case2 $S_{soil}$ (mm)']
#     level = level1
#     cmap = cmap1
#     draw(name,level,cmap)

# def Ssoil_case3():
#     name = [f'{path3}Ssoil_mean', 'Ssoil', 'Ssoil_case3', 'model case3 $S_{soil}$ (mm)']
#     level = level1
#     cmap = cmap1
#     draw(name,level,cmap)

def Sr_case1():
    name = [f'{path1}Sr_mean', 'Sr', 'Sr_case1', 'model case1 $S_{r}$ (mm)']
    level = level1
    cmap = cmap1
    draw(name,level,cmap)
        
def Sr_case2():
    name = [f'{path2}Sr_mean', 'Sr', 'Sr_case2', 'model case2 $S_{r}$ (mm)']
    level = level1
    cmap = cmap1
    draw(name,level,cmap)

def Sr_case3():
    name = [f'{path3}Sr_mean', 'Sr', 'Sr_case3', 'model case3 $S_{r}$ (mm)']
    level = level1
    cmap = cmap1
    draw(name,level,cmap)

# def Sr_case1():
#     name = [f'{path1}Sr_mean', 'Sr', 'Sr_case1', 'model case1 Sr']
#     level = level1
#     cmap = cmap1
#     draw(name,level,cmap)
        
# def Sr_case2():
#     name = [f'{path2}Sr_mean', 'Sr', 'Sr_case2', 'model case1 Sr']
#     level = level1
#     cmap = cmap1
#     draw(name,level,cmap)

# def Sr_case3():
#     name = [f'{path3}Sr_mean', 'Sr', 'Sr_case3', 'model case1 Sr']
#     level = level1
#     cmap = cmap1
#     draw(name,level,cmap)

# def PSr_case1():
#     name = [f'{path1}PSr_mean', 'PSr', 'PSr_case1', 'model case1 PSr']
#     level = level1
#     cmap = cmap1
#     draw(name,level,cmap)
        
# def PSr_case2():
#     name = [f'{path2}PSr_mean', 'PSr', 'PSr_case2', 'model case1 PSr']
#     level = level1
#     cmap = cmap1
#     draw(name,level,cmap)

# def PSr_case3():
#     name = [f'{path3}PSr_mean', 'PSr', 'PSr_case3', 'model case1 PSr']
#     level = level1
#     cmap = cmap1
#     draw(name,level,cmap)
