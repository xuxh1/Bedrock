...
def plot_Con():
   ...
   violin_plot.save('fig5/con.pdf', transparent=True, bbox_inches='tight')
   violin_plot.save('fig5/con.png')
...
def plot_Sub():
   ...
   figure_size=(16, 8))
            + labs(x='', y="$S_{{bedrock}}$ (mm)"))
   violin_plot.save('fig5/sub.pdf', transparent=True, bbox_inches='tight')
   violin_plot.save('fig5/sub.png')
...
def plot_Sov():
   ...
   violin_plot.save('fig5/sov.pdf', transparent=True, bbox_inches='tight')
   violin_plot.save('fig5/sov.png')
...
def plot_Koppen():
   ...
   figure_size=(16, 8))
            + labs(x="", y="$S_{{bedrock}}$ (mm)"))
   violin_plot.save('fig5/koppen.pdf', transparent=True, bbox_inches='tight')
   violin_plot.save('fig5/koppen.png')
...
def plot_Landcover():
   ...
   figure_size=(16, 8))
            + labs(x="", y="$S_{{bedrock}}$ (mm)"))
   violin_plot.save('fig5/landcover.pdf', transparent=True, bbox_inches='tight')
   violin_plot.save('fig5/landcover.png')
