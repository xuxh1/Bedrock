...
print('python draw_g1_imshow_proportion.py')
...
def P1():
    ...
    # name = ['Proportion1_median', 'Sr', 'P1_n2p', '$S_{{bedrock}}$/$S_{{r}}$']
    # level = level4
    # cmap = cmap4
    # draw(name,level,cmap)
    # name = ['Proportion1_median_temp1', 'Sr', 'P1_n2p_nm', '$S_{{bedrock}}$/$S_{{r}}$']
    # level = level4
    # cmap = cmap4
    # draw(name,level,cmap)
        
def P2():
    name = ['Proportion2_median', 'Sr', 'P2', '$S_{{bedrock}}$/ET (%)']
    level = np.arange(0,120,20)
    cmap = cmaps.cmocean_balance
    draw(name,level,cmap)
    # name = ['Proportion2_median', 'Sr', 'P2_n2p', '$S_{{bedrock}}$/ET']
    # level = level4
    # cmap = cmap4
    # draw(name,level,cmap)
    # name = ['Proportion2_median_temp1', 'Sr', 'P2_n2p_nm', '$S_{{bedrock}}$/ET']
    # level = level4
    # cmap = cmap4
    # draw(name,level,cmap)

def P3():
    name = ['Proportion3_median', 'tp', 'P3', 'Q/PR (%)']
    level = np.arange(0,120,20)
    cmap = cmaps.cmocean_balance
    draw(name,level,cmap)
    # name = ['Proportion3_median', 'tp', 'P3_n2p', 'Q/PR']
    # level = level4
    # cmap = cmap4
    # draw(name,level,cmap)
    # name = ['Proportion3_median_temp1', 'tp', 'P3_n2p_nm', 'Q/PR']
    # level = level4
    # cmap = cmap4
    # draw(name,level,cmap)

def P4():
    name = ['Proportion4_median', 'et', 'P4', 'ET/PR (%)']
    level = np.arange(0,120,20)
    cmap = cmaps.cmocean_balance
    draw(name,level,cmap)

def P5():
    name = ['Proportion5_median', 'Sr', 'P5', '$S_{{bedrock}}$/PR (%)']
    level = np.arange(0,120,20)
    cmap = cmaps.cmocean_balance
    draw(name,level,cmap)

def P6():
    name = ['Proportion6_median', 'et', 'P6', '(ET - $S_{{bedrock}}$)/PR (%)']
    level = np.arange(0,120,20)
    cmap = cmaps.cmocean_balance
    draw(name,level,cmap)

def P7():
    name = ['Proportion7_median', 'Band1', 'P7', 'PET/PR (%)']
    level = np.arange(0,120,20)
    cmap = cmaps.cmocean_balance
    draw(name,level,cmap)
