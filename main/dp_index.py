...
def Sbedrock_div_Sr():
    ...
    subprocess.run(f"cdo mul P/Sbedrock_div_Sr_tmp1.nc4 mask1234.nc4 P/Sbedrock_div_Sr_tmp2.nc4", shell=True, check=True)
...
def Sbedrock_div_ET_mean():
    ...
    subprocess.run(f"cdo mul P/Sbedrock_div_ET_mean_tmp1.nc4 mask1234.nc4 P/Sbedrock_div_ET_mean_tmp2.nc4", shell=True, check=True)
...
def Sbedrock_div_PR_mean():
    ...
    subprocess.run(f"cdo mul P/Sbedrock_div_PR_mean_tmp1.nc4 mask1234.nc4 P/Sbedrock_div_PR_mean_tmp2.nc4", shell=True, check=True)
...
def ET_mean_div_PR_mean():
    ...
    subprocess.run(f"cdo mul P/ET_mean_div_PR_mean_tmp1.nc4 mask1234.nc4 P/ET_mean_div_PR_mean_tmp2.nc4", shell=True, check=True)
...
def ET_mean_sub_Sbedrock_div_PR_mean():
    ...
    subprocess.run(f"cdo mul P/ET_mean_sub_Sbedrock_div_PR_mean_tmp1.nc4 mask1234.nc4 P/ET_mean_sub_Sbedrock_div_PR_mean_tmp2.nc4", shell=True, check=True)
...
def Q_mean_div_PR_mean():
    ...
    subprocess.run(f"cdo mul P/Q_mean_div_PR_mean_tmp1.nc4 mask1234.nc4 P/Q_mean_div_PR_mean_tmp2.nc4", shell=True, check=True)
...
def PET_div_PR_mean():
    ...
    subprocess.run(f"cdo mul P/PET_div_PR_mean_tmp1.nc4 mask1234.nc4 P/PET_div_PR_mean_tmp2.nc4", shell=True, check=True)
