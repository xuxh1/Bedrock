...
def saws(casename):
    path = f'/tera04/zhwei/xionghui//wetland/cases/{casename}/history/'
    path2 = f'/tera04/zhwei/xionghui/bedrock/run/{resolution}/cases/{casename}/tmp/'
...
def DTB_saws_to_Ssoil(casename):
    path1 = f'/tera04/zhwei/xionghui/bedrock/run/0p1/'
    path2 = f'/tera04/zhwei/xionghui/bedrock/run/{resolution}/cases/{casename}/'
    # os.makedirs(path2, exist_ok=True)
...
# def Sr(casename):
#     path = f'/tera04/zhwei/xionghui//wetland/cases/{casename}/history/'
#     path2 = f'/tera04/zhwei/xionghui/bedrock/run/0p1/cases/{casename}/tmp/'
#     os.chdir(path2)
#     for year in range(2003,2021):
#         print(f'Sr data process year is {year}')
#         monday = [31,28,31,30,31,30,31,31,30,31,30,31]
