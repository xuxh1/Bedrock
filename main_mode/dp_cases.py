...
def dp_Ssoil_mean(path):
    ...
    os.system(f"cdo mul {path}Ssoil_mean_tmp2.nc4 mask1234.nc4 {path}Ssoil_mean.nc4")
...
def dp_Sr_mean(path):
    ...
    os.system(f"cdo mul {path}Sr_mean_tmp2.nc4 mask1234.nc4 {path}Sr_mean.nc4")
...
def dp_Sbedrock(path):
    ...
    os.system(f"cdo mul {path}Sbedrock_mean_tmp2.nc4 mask1234.nc4 {path}Sbedrock_mean.nc4")
...
def dp_rnof_mean(path):
    ...
    os.system(f"cdo -O -mul {path}rnof_mean_tmp2.nc4 mask1234.nc4 {path}rnof_mean.nc4")
...
def dp_fevpa_mean(path):
    ...
    os.system(f"cdo -O -mul {path}fevpa_mean_tmp2.nc4 mask1234.nc4 {path}fevpa_mean.nc4")
...
#     os.system(f"cdo mul {path}PSr_mean_tmp2.nc4 mask1234.nc4 {path}PSr_mean.nc4")
